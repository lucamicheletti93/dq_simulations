...
export ALIEN_JDL_LPMPRODUCTIONTAG="test_prompt_charmonia_anchor_25OO5TeV"
#export ALIEN_JDL_LPMANCHORRUN="559348"
export ALIEN_JDL_LPMANCHORPRODUCTION="LHC25aeMC"
...
#export ALIEN_JDL_O2DPG_ASYNC_RECO_TAG="/cvmfs/alice.cern.ch/el9-x86_64/Packages/O2DPG/daily-20251008-0000-1"    
export O2DPG_MC_CONFIG_ROOT="/cvmfs/alice.cern.ch/el9-x86_64/Packages/O2DPG/daily-20251008-0000-1"
export INIPATH="${O2DPG_MC_CONFIG_ROOT}/MC/config/PWGDQ/ini/Generator_InjectedPromptCharmoniaFwdy_TriggerGap_OO5TeV.ini"
export ALIEN_JDL_ANCHOR_SIM_OPTIONS="-gen external -ini $INIPATH -genBkg pythia8 -procBkg heavy_ion --embedding --embeddPattern @0:e1"
