...
export ALIEN_JDL_LPMPRODUCTIONTAG=${ALIEN_JDL_LPMPRODUCTIONTAG:-"CaroTest_charmBaryons_woOmega"}
...
export ALIEN_JDL_ANCHOR_SIM_OPTIONS="-gen external -ini $O2DPG_ROOT/MC/config/PWGLF/ini/GeneratorLFNucleiFwdppGap.ini"
